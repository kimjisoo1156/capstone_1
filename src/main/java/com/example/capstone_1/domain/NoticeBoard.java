...
public class NoticeBoard extends BaseEntity{
    ...
    public void addImageNoticeBoard(String uuid, String fileName){
        ...
        BoardImage boardImage = BoardImage.builder()
                ...
                .build();
        imageSetNoticeBoard.add(boardImage);
    }

    public void clearImagesNoticeBoard() {

        imageSetNoticeBoard.forEach(boardImage -> boardImage.changeBoardNoticeBoard(null));

        this.imageSetNoticeBoard.clear();
    }
}
